(function(){
    ...
    (function(){
        ...
        function defineModel(_e, _model) {
            ...
            //sentence.push('\t' + common.dromedary(_e.name,'_').capitalize()+".sync({force:false}).then(function(){\n");
            ...
            if (typeof _e.columns != 'undefined') {
                ...
                _e.columns.forEach(function(c, idx, array){
                    ...
                    sentence.push(common.dromedary(_e.name,'_').capitalize()+
                        ".belongsTo(" +common.dromedary(referencedEntity,'_').capitalize() +
                        ", { foreignKey: '"+ c.name + "'} );");
        ...
        function defineColumns(_e, _model){
            ...
            _e.columns.forEach(function(c, idx, array){
                ...
                if (c.foreignKey) return; //Foreign Keys Are defined later on as Sequelize relations
